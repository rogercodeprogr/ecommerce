<?php
    ...
    class Mailer    
    {
        ...
        const USERNAME = "Nao divulgado";       
        const PASSWORD = "Nao divulgado";
        const NAME_FROM = "Nao divulgado";
        private $mail;
        ...
        //Use `$email->Host = gethostbyname('smtp.gmail.com');`
